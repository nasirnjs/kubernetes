...
import (
	...
	"github.com/nasirnjs/ecommerce/shipping-service/internal/config"
	"github.com/nasirnjs/ecommerce/shipping-service/internal/handler"
...
func main() {
	...
	go func() {
		log.Printf("shipping-service listening on :%s", cfg.Port)
