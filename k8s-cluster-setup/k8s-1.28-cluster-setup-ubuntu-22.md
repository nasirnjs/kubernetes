...
`sudo kubeadm init --apiserver-advertise-address=172.17.18.210 --pod-network-cidr=192.168.247.0/16 --cri-socket /run/containerd/containerd.sock --ignore-preflight-errors Swap`
